    ...
    <>
      <div className="min-h-screen p-8">
        <div className="max-w-lg mx-auto">
          ...
          <div
            className={`rounded-2xl p-0.5 ${isDark ? "bg-gradient-to-r from-[var(--primary-border)] to-[var(--toggle-slider-bg)]" : ""}`}
          >
            <div
              className={`${isDark ? "bg-[var(--claim-burn-bg)]" : "border bg-[var(--container)] border-[var(--card-border)]"} rounded-[14px]`}
            >
              <div className="flex justify-end p-4 cursor-pointer">
                <Hamburger />
              </div>
              <div
                className={`rounded-4xl ${isDark ? "border-2 bg-[var(--claim-area)] border-[var(--primary-border)]" : "bg-white border border-[var(--card-border)] shadow-[0px_0px_14px_0px_#00000014]"} h-fit p-6`}
              >
